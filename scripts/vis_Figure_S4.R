...
# F] Figure S4A, S4B - chr7, chr10, PTEN + EGFR ----
...
ggplot(plt.expanded, aes(
  x = log2FoldChange.gsam.res, y = statistic.gsam.cor.tpc, shape = limited,
...
ggsave("output/figures/2022_Figure_S4C__LFC_per_chr.pdf", width=8.3 / 2,height=8.3/6, scale=2)




# F] Figure S4D, S4E, S4F, S4G, S4H & S4I - geiser plots x hallmark genes ----
