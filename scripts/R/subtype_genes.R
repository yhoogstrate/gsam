...
proneural.glits.redux.tt2['1'] <- 'KLRC4'
proneural.glits.redux.tt2['2'] <- 'GRID2'
proneural.glits.redux.tt2['3'] <- 'UGT8'
proneural.glits.redux.tt2['4'] <- 'EPHB1'
proneural.glits.redux.tt2['5'] <- 'MYT1'
proneural.glits.redux.tt2['6'] <- 'DCX'
proneural.glits.redux.tt2['7'] <- 'KLRC3'
proneural.glits.redux.tt2['8'] <- 'TMSB15A'
proneural.glits.redux.tt2['9'] <- 'CNTN1'
proneural.glits.redux.tt2['10'] <- 'ERBB3'
proneural.glits.redux.tt2['11'] <- 'PLAAT1' # formerly known as 'HRASLS' [https://www.genecards.org/cgi-bin/carddisp.pl?gene=PLAAT1]
proneural.glits.redux.tt2['12'] <- 'DNM3'
proneural.glits.redux.tt2['13'] <- 'SCN3A'
proneural.glits.redux.tt2['14'] <- 'PAK3'
proneural.glits.redux.tt2['15'] <- 'GNG4'
proneural.glits.redux.tt2['16'] <- 'AMOTL2'
proneural.glits.redux.tt2['17'] <- 'CHD7'
proneural.glits.redux.tt2['18'] <- 'CRMP1'
proneural.glits.redux.tt2['19'] <- 'SOX4'
proneural.glits.redux.tt2['20'] <- 'SATB1'

mesenchymal.glits.redux.tt2 <- {{}}
mesenchymal.glits.redux.tt2['1`'] <- 'LOX'
mesenchymal.glits.redux.tt2['2'] <- 'SERPINE1'
mesenchymal.glits.redux.tt2['3'] <- 'COL1A1'
mesenchymal.glits.redux.tt2['4'] <- 'CRYBG1' # formerly known as 'AIM1' [https://www.genecards.org/cgi-bin/carddisp.pl?gene=CRYBG1]
mesenchymal.glits.redux.tt2['5'] <- 'FCGR2B'
mesenchymal.glits.redux.tt2['6'] <- 'COL1A2'
mesenchymal.glits.redux.tt2['7'] <- 'FHL2'
mesenchymal.glits.redux.tt2['8'] <- 'IGFBP6'
mesenchymal.glits.redux.tt2['9'] <- 'TGFBI'
mesenchymal.glits.redux.tt2['10'] <- 'PLAU'
mesenchymal.glits.redux.tt2['11'] <- 'P4HA2'
mesenchymal.glits.redux.tt2['12'] <- 'CSTA'
mesenchymal.glits.redux.tt2['13'] <- 'DSE'
mesenchymal.glits.redux.tt2['14'] <- 'LAMB1'
mesenchymal.glits.redux.tt2['15'] <- 'SRPX2'
mesenchymal.glits.redux.tt2['16'] <- 'TIMP1'
mesenchymal.glits.redux.tt2['17'] <- 'S100A11'
mesenchymal.glits.redux.tt2['18'] <- 'PLAUR'
mesenchymal.glits.redux.tt2['19'] <- 'FPR3'
mesenchymal.glits.redux.tt2['20'] <- 'CLEC2B'
mesenchymal.glits.redux.tt2['21'] <- 'DCBLD2'
mesenchymal.glits.redux.tt2['22'] <- 'MYOF'
mesenchymal.glits.redux.tt2['23'] <- 'MAFB'
mesenchymal.glits.redux.tt2['24'] <- 'ARPC1B'
mesenchymal.glits.redux.tt2['25'] <- 'RAB27A'
mesenchymal.glits.redux.tt2['26'] <- 'LY75'
mesenchymal.glits.redux.tt2['27'] <- 'PLBD1'
mesenchymal.glits.redux.tt2['28'] <- 'LY96'
