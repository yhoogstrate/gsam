...
#Load data
gencode.31 <- read.delim("/mnt/data/ccbc_environment/project/gsam-neurology/ref/star-hg19/gencode.v31lift37.annotation.gtf", comment.char="#",stringsAsFactors = F,header=F) %>%
...
#expression_matrix_full <- read.delim("data/output/tables/gsam_featureCounts_readcounts_new.txt",stringsAsFactors = F,comment="#")
expression_matrix_full_new <- read.delim("data/gsam_featureCounts_readcounts_new.txt",stringsAsFactors = F,comment="#") %>%
