...
ggbiplot::ggscreeplot(tmp.c1.collagen)
paste0(round((tmp.c1.collagen$sdev)^2/sum((tmp.c1.collagen$sdev)^2) * 100,2),"%") # https://datavizpyr.com/how-to-make-scree-plot-in-r-with-ggplot2/
