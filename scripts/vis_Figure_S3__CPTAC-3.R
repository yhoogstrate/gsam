...
ggsave(paste0("output/figures/2022_Figure_S3-p08_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
...
ggsave(paste0("output/figures/2022_Figure_S3-p07_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
...
ggsave(paste0("output/figures/2022_Figure_S3-p11_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p10_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
# C_CPT0205450015 - C3N-02190 - [clean sample] ----
...
ggsave(paste0("output/figures/2022_Figure_S3-p14_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p13_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
object_1 <- reorder_levels(object_1, c("", "EN|PE", "TC", "TAM", "NE", "OD", "AC", "T"))
...
ggsave(paste0("output/figures/2022_Figure_S3-p17_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p16_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
#ggsave(paste0("output/figures/2022_Figure_S9_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
#rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
object_1$cell_type = ifelse(object_1$seurat_clusters %in% c(17), "OPC", object_1$cell_type)
object_1$cell_type = ifelse(object_1$seurat_clusters %in% c(21), "TACSTD2+", object_1$cell_type)
object_1$annotated_clusters = paste0(object_1$seurat_clusters,". ",object_1$cell_type)


object_1 <- reorder_levels(object_1, c("", "EN","PE", "BC", "TC", "TAM", "NE", "TACSTD2+", "OPC", "OD", "AC", "T"))
...
ggsave(paste0("output/figures/2022_Figure_S3-p20_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p19_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
ggsave(paste0("output/figures/2022_Figure_S3-p23_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p22_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
ggsave(paste0("output/figures/2022_Figure_S3-p26_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p25_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
ggsave(paste0("output/figures/2022_Figure_S3-p29_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p28_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
...
object_1$cell_type = ifelse(object_1$seurat_clusters %in% c(20), "PERP+", object_1$cell_type)
object_1$annotated_clusters = paste0(object_1$seurat_clusters,". ",object_1$cell_type)


object_1 <- reorder_levels(object_1, c("", "PERP+", "EL", "EN","PE", "BC", "TC", "TAM", "NE", "OD", "AC", "T"))
...
ggsave(paste0("output/figures/2022_Figure_S3-p32_ext_CPTAC-3_",sid,"_C4_DP.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c4, tmp.c4.npc2, tmp.npc1, tmp.npc1.2, tmp.npc2, sid_print)
...
ggsave(paste0("output/figures/2022_Figure_S3-p31_ext_CPTAC-3_",sid,"_C3.pdf"), width=7.5 * 1.8 * (612 / 744.4529) * (392.0837 / 412.4028 ), height=3.75 * 0.93, scale=1.2)
rm(tmp.c3, tmp.opc, tmp.c3.opc)
