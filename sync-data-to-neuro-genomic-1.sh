...
rsync -avP --exclude ".*" --exclude "__pycache__" --exclude "tin.py" --exclude "*.bam" --exclude "*.bai" --no-links 'output/tables/' 'gsamadmin@neuro-genomic-1.erasmusmc.nl:/volume1/gsam/output/tables/'
